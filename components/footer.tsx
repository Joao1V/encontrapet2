    ...
    <footer className="bg-muted/30 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground font-heading">EncontraPet</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/dicas" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Dicas e Orientações
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:contato@encontrapet.com.br" className="hover:text-foreground transition-colors">
                  contato@encontrapet.com.br
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" />
                <a href="tel:+5567999999999" className="hover:text-foreground transition-colors">
                  (67) 99999-9999
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">© 2025 EncontraPet. Todos os direitos reservados.</p>
          <div className="flex gap-6">
            ...
            <Link href="/lgpd" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
              LGPD
            </Link>
          </div>
        </div>
