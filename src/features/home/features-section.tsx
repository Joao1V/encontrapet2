...
const features = [
   ...
   },
   {
      ...
      description:
         'Receba alertas instantâneos sobre novos registros na sua área de interesse.',
   },
   {
      icon: Share2,
   ...
   },
   {
      ...
      description:
         'Conecte-se com ONGs, clínicas veterinárias e protetores independentes.',
   },
];
         ...
         <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
               ...
               <p className="text-lg text-default-600 leading-relaxed">
                  Recursos pensados para facilitar o reencontro e fortalecer a
